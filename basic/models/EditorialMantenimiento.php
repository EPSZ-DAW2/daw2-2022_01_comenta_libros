 ...
 */
class EditorialMantenimiento extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return EditorialesMantenimientoQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new EditorialesMantenimientoQuery(get_called_class());
    }
